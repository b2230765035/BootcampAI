...
class IsAuthenticatedRequest extends UserBlocEvent {
  const IsAuthenticatedRequest();
}

class GetUserProfilePictureRequest extends UserBlocEvent {
  String username;
  GetUserProfilePictureRequest({required this.username});
}
